...
export default function OnboardingScreen() {
  ...
  const onHeightViewableItemsChanged = useRef(
    ({ viewableItems }: { viewableItems: ViewToken[] }) => {
      const centered = viewableItems.find(
        (item) => item.isViewable && item.item != null,
      );
              ...
              <FlatList
                ...
                renderItem={({ item }) => {
                  ...
                  return (
                    ...
                    >
                      <Text
                        className={`font-semibold ${selected ? "text-5xl text-white" : "text-4xl text-[#5F52A2]"}`}
                      >
                        {item}
                      </Text>
                    </View>
        ...
        {step === 3 && (
          <View className="flex-1 items-center">
            ...
            <View className="mt-10 flex-row items-end">
              ...
              <Text className="mb-2 ml-1 text-3xl font-semibold text-[#4A4656]">
                cm
              </Text>
            </View>
            <View className="relative mt-8 h-[300px] w-[116px] overflow-hidden rounded-2xl bg-[#A89AF4] py-2">
                ...
                renderItem={({ item }) => {
                  ...
                  return (
                    <View className="h-[52px] items-center justify-center">
                      <Text
                        className={`${selected ? "text-4xl font-bold text-black" : "text-3xl font-semibold text-[#6E6A79]"}`}
                      >
                        {item}
                      </Text>
                    </View>
              ...
              <View
                pointerEvents="none"
                className="absolute left-0 right-0 top-1/2 -mt-[1px] h-[2px] bg-[#D4DD56]"
              />
            </View>
            <Text className="absolute right-[70px] top-[270px] text-2xl text-[#D4DD56]">
              ◀
            </Text>
          </View>
        )}
